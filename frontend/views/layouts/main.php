        ...
        <div>
          ...
          <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="/user/about-us" aria-expanded="false">
                  <span>
                    <i class="ti ti-layout-dashboard"></i>
                  </span>
              ...
              if (Yii::$app->user->isGuest) {
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="./signup" aria-expanded="false">
                    <span>
                      <i class="ti ti-layout-dashboard"></i>
                    </span>
                ...
                <li class="sidebar-item">
                  ...
                  <span class="hide-menu">Transfer</span>', ['user/transfer'], ['data-method' => 'post', 'class' => 'sidebar-link']); ?>
                </li>
                <li class="sidebar-item">
                  <?php echo Html::a('
                  <span>
                  ...
                  <span class="hide-menu">Logout</span>', ['user/logout'], ['data-method' => 'post', 'class' => 'sidebar-link']); ?>
